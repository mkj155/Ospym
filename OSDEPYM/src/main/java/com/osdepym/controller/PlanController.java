...
public class PlanController {
	...
	private List<PlanSectionDTO> getPlanSections(String idPlan) {
		...
		piDTO.setTitle("Consulta en consultorio Equipo Base de Atención Primaria");
		piDTO.setValue("S/C");
		itemsList.add(piDTO);
		...
		piDTO = new PlanItemDTO();
		piDTO.setTitle("Consulta Diurna (Código Verde)");
		piDTO.setValue("$ 310");
		subitemsList.add(piDTO);
		
		piDTO = new PlanItemDTO();
		piDTO.setTitle("Consulta Nocturna (Código Verde)");
		piDTO.setValue("$ 434");
		subitemsList.add(piDTO);
		
		piDTO = new PlanItemDTO();
		piDTO.setTitle("Atención domiciliaria");
		piDTO.setValue(null);
		...
		piDTO = new PlanItemDTO();
		piDTO.setTitle("Consulta a la noche (Código Verde)");
		piDTO.setValue("$ 434");
		subitemsList.add(piDTO);
