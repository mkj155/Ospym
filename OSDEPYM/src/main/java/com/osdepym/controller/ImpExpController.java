...
public class ImpExpController {
	...
	public ModelAndView submitContactoForm(@ModelAttribute("impExpForm") @Validated ImpExpForm impExpForm, BindingResult result, Model model, final RedirectAttributes redirectAttributes) {
		ModelAndView view = null;
		try {
			if (result.hasErrors()) {
