    ...
    <section id="beneficios">
        ...
        <div class="container text-center">
            <ul class="list-unstyled list-inline row">
                ...
                <li class="list-inline-item col">
                    <img src="/OSDEPYM/resources/core/img/icons-02.svg" class="d-none d-md-block" alt="Planes y Cobertura">
                    <div class="d-md-none">
                        <div class="row">
                            <div class="col-3 text-center">
                                <img src="/OSDEPYM/resources/core/img/icons-mobile-02.svg" alt="Planes y Cobertura">
                            </div>
                            <div class="col-9 text-left">
                                <span class="text">Planes y Cobertura</span>
                            </div>
                        </div>
                    </div>
                </li>
                <li class="list-inline-item col">
                    <img src="/OSDEPYM/resources/core/img/icons-03.svg" class="d-none d-md-block" alt="Más de 6500 prestadores">
                    <div class="d-md-none">
                        <div class="row">
                            <div class="col-3 text-center">
                                <img src="/OSDEPYM/resources/core/img/icons-mobile-03.svg" alt="Más de 6500 prestadores">
                            </div>
                            <div class="col-9 text-left">
                                <span class="text">Más de 6500 prestadores</span>
                            </div>
                        </div>
                    </div>
                </li>
