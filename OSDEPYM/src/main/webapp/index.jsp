...
<!--                         <span class="icon"><i class="fas fa-envelope"></i></span> -->
                    ...
                    <div class="col-lg-3 col-btn">
                        <a target="blank" href="https://www.osdepym.com.ar/micrositio-beneficiarios/login" role="button" class="btn btn-outline-primary btn-block btn-sm">TRÁMITES ONLINE</a>
                        <a href="./app.htm?page=contacto" role="button" class="btn btn-outline-primary btn-block btn-sm">CONTÁCTENOS</a>
